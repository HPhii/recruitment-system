...
public class CvAiExtractorService {
    ...
    private static final String SYSTEM_PROMPT = """
        ...
        Match skills from the CV EXACTLY with the following list and return ONLY the skills that are an exact match from this list. Do NOT infer or return any skills not explicitly listed below:
        ...
        The skill like Java, you have to return "Java/Kotlin", remember to return the exact skill as listed above, 1 cv can have many skills.
